...
ALTER TABLE ORDERDETAIL
 ...
 GRANT INSERT, UPDATE ON SAM.ORDERS TO NITO;
 GRANT SELECT ON SAM.POINTS TO NITO;
 GRANT SELECT ON SAM.ORDERDETAIL TO NITO;
 GRANT INSERT, UPDATE ON SAM.ORDERDETAIL TO NITO;
 ...
 GRANT INSERT, UPDATE ON SAM.ORDERS TO IU;
 GRANT SELECT, INSERT, UPDATE ON SAM.POINTS TO IU;
 GRANT SELECT ON SAM.ORDERDETAIL TO IU;
 GRANT INSERT, UPDATE ON SAM.ORDERDETAIL TO IU;
...
SELECT GOCODE,
        ...
        SUM(OTQTY) AS "OTQTY"
FROM DAILYSALES
WHERE ODCODE LIKE '202010' || '%' AND STCODE = 'S001'
